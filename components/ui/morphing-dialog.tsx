...
export type MorphingDialogProps = {} & MorphingDialogProviderProps
...
export function MorphingDialogContainer({ children, className, overlay = true }: MorphingDialogContainerProps) {
...
export function MorphingDialogTitle({ children, className, style }: MorphingDialogTitleProps) {
	...
	return (
		<motion.div layoutId={`dialog-title-container-${uniqueId}`} className={cn("", className)} style={style} layout>
			{children}
		</motion.div>
	)
}
...
export function MorphingDialogSubtitle({ children, className, style }: MorphingDialogSubtitleProps) {
	const { uniqueId } = useMorphingDialog()

	return (
		<motion.div layoutId={`dialog-subtitle-container-${uniqueId}`} className={cn("", className)} style={style}>
			{children}
		</motion.div>
	)
}
